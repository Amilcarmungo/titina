...
export function AdminGate({ children }: { children: React.ReactNode }) {
  ...
  if (loading)
    return <Notice title="A verificar permissões…" text="Um instante." />;
    ...
    <div className="grid min-h-screen place-items-center bg-muted/30 px-6">
      <div className="w-full max-w-sm rounded-2xl bg-background p-6 text-center shadow-xl">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Esta conta não tem permissão para entrar no painel. Se acredita que se
          trata de um engano, fale com um administrador da loja.
        </p>
    ...
    <div className="grid min-h-screen place-items-center bg-muted/30 px-6">
      <div className="w-full max-w-sm rounded-2xl bg-background p-6 shadow-xl">
        ...
        <p className="mt-1 text-center text-xs text-muted-foreground">
          Acesso apenas para a equipa autorizada.
        </p>
