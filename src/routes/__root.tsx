  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Toaster
        ...
        visibleToasts={3}
        icons={{
          success: <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-emerald-500 text-white">✓</span>,
          error: <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-red-500 text-white">!</span>,
          warning: <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-amber-500 text-white">!</span>,
          info: <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-foreground text-background">i</span>,
        }}
