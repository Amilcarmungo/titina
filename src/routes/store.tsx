...
export const Route = createFileRoute("/store")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Descubra a loja oficial MonkeyK Beauty Tool na Bazarixy. Produtos de beleza com alta taxa de recompra." },
    ],
  }),
  component: StorePage,
});
  ...
  return (
    <Layout simpleHeader hideBottomNav>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5">
              <h1 className="truncate font-display text-lg font-black md:text-2xl">MonkeyK Beauty Tool</h1>
            ...
            <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] text-muted-foreground md:text-xs">
              ...
              <span className="flex items-center gap-1"><Flame className="h-3.5 w-3.5 text-sale" /> 99K+ vendidos</span>
            </div>
          </div>
      ...
      <div className="mx-4 mb-6 rounded-lg bg-gradient-to-r from-sale/10 to-gold/10 p-3 text-xs">
        ...
        <span className="font-bold">15%</span>. Descubra mais ofertas imperdíveis
