  ...
  head: () => ({
    meta: [
      { title: "Política de Privacidade — Bazarixy" },
      {
        name: "description",
        content:
          "Política de privacidade da plataforma Bazarixy, incluindo recolha, utilização, proteção e partilha de dados pessoais.",
      },
      { property: "og:title", content: "Política de Privacidade — Bazarixy" },
      {
        property: "og:description",
        content:
          "Como o Bazarixy recolhe, utiliza, protege e partilha os dados dos utilizadores.",
      },
