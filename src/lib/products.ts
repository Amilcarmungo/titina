...
export const seedProducts: Product[] = [
  {
    id: "1",
    name: "Vestido Midi Elegante Preto",
    price: 89.9,
    oldPrice: 159.9,
    image: dress,
    category: "dresses",
    ...
    reviews: 1248,
    sold: 3200,
    colors: ["#000", "#7a2828", "#1a3a5a"],
    sizes: ["P", "M", "G", "GG"],
    description:
      "Vestido midi preto com fenda lateral, tecido fluido e caimento perfeito. Ideal para ocasiões especiais.",
  },
  {
    id: "2",
    name: "Blusa Manga Bufante Off-White",
    price: 49.9,
    oldPrice: 79.9,
    image: top,
    category: "tops",
    ...
    reviews: 892,
    sold: 2100,
    colors: ["#f5f0e6", "#000", "#c9a4a4"],
    sizes: ["PP", "P", "M", "G"],
    description:
      "Blusa romântica com mangas bufantes e decote V. Tecido leve e respirável.",
  },
  {
    id: "3",
    name: "Calça Cargo Bege Premium",
    price: 119.9,
    oldPrice: 199.9,
    image: pants,
    category: "pants",
    ...
    reviews: 654,
    sold: 1850,
    colors: ["#c9b48a", "#2e2e2e", "#5a4a3a"],
    sizes: ["36", "38", "40", "42", "44"],
    description: "Calça cargo bege com bolsos funcionais e ajuste confortável.",
  },
  {
    id: "4",
    name: "Calça Jeans Reta Vintage",
    price: 99.9,
    oldPrice: 169.9,
    image: jeans,
    category: "denim",
    ...
    reviews: 2103,
    sold: 5400,
    colors: ["#4a6b8a", "#2a3a5a"],
    sizes: ["36", "38", "40", "42"],
    description: "Jeans reto vintage com lavagem clara e detalhes destroyed.",
  },
  {
    id: "5",
    name: "Maiô Floral Tropical",
    price: 79.9,
    oldPrice: 129.9,
    image: swim,
    category: "swim",
    ...
    colors: ["#c63950"],
    sizes: ["P", "M", "G"],
    description: "Maiô estampa floral, modelagem alta e bojo removível.",
  },
  {
    id: "6",
    name: "Regata Básica Verde Esmeralda",
    price: 29.9,
    oldPrice: 49.9,
    image: tank,
    category: "tops",
    ...
    reviews: 1876,
    sold: 4200,
    colors: ["#1f8a4a", "#000", "#fff", "#c63950"],
    sizes: ["PP", "P", "M", "G", "GG"],
    description:
      "Regata básica em malha premium, caimento solto e confortável.",
  },
  {
    id: "7",
    name: "Saia Mini Godê Preta",
    price: 59.9,
    oldPrice: 99.9,
    image: skirt,
    category: "skirts",
    ...
    sizes: ["P", "M", "G"],
    description:
      "Saia mini godê preta com forro interno. Versátil para o dia ou noite.",
  },
  {
    id: "8",
    name: "Macacão Verde Militar",
    price: 139.9,
    oldPrice: 229.9,
    image: jumpsuit,
    category: "jumpsuits",
    ...
    reviews: 432,
    sold: 1050,
    colors: ["#6b7a3a", "#2e2e2e"],
    sizes: ["P", "M", "G", "GG"],
    description:
      "Macacão longo verde militar com cinto removível e pernas amplas.",
  },
  {
    id: "9",
    name: "Vestido Renda Vermelho Midi",
    price: 159.9,
    oldPrice: 279.9,
    image: reddress,
    category: "dresses",
    ...
    sizes: ["P", "M", "G"],
    description:
      "Vestido em renda vermelha sofisticada, perfeito para eventos.",
  },
  {
    id: "10",
    name: "Cardigan Tricô Bege Oversized",
    price: 109.9,
    oldPrice: 179.9,
    image: knit,
    category: "knit",
    ...
    reviews: 980,
    sold: 2400,
    colors: ["#d4c4a8", "#2e2e2e", "#a4a4a4"],
    sizes: ["Único"],
    description: "Cardigan oversized em tricô premium, super confortável.",
  },
  {
    id: "11",
    name: "Batom Matte Rosa Luxo",
    price: 24.9,
    oldPrice: 44.9,
    image: lipstick,
    category: "beleza",
    ...
    reviews: 2140,
    sold: 6800,
    colors: ["#c9364d", "#b8425c", "#8a2d3f"],
    sizes: ["Único"],
    description:
      "Batom matte de longa duração com pigmentação intensa. Acabamento aveludado.",
  },
  {
    id: "12",
    name: "Perfume Floral Rose 100ml",
    price: 189.9,
    oldPrice: 299.9,
    image: perfume,
    category: "beleza",
    ...
    sizes: ["100ml"],
    description:
      "Fragrância floral sofisticada com notas de rosa, jasmim e âmbar.",
  },
  {
    id: "13",
    name: "Creme Facial Hidratante Gold",
    price: 79.9,
    oldPrice: 129.9,
    image: cream,
    category: "beleza",
    ...
    sizes: ["50g"],
    description:
      "Creme hidratante premium com fórmula anti-idade e efeito iluminador.",
  },
  {
    id: "14",
    name: "Kit Pincéis Rose Gold 5pçs",
    price: 59.9,
    oldPrice: 99.9,
    image: brushes,
    category: "beleza",
    ...
    sizes: ["Kit 5"],
    description:
      "Kit profissional com 5 pincéis de maquiagem em rose gold. Cerdas ultra macias.",
  },
];
