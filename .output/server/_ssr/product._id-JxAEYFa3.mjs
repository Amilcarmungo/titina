...
import { P as useStore, R as productUrl, l as actions, o as Route$3 } from "./router-BdTihO2k.mjs";
...
import { Bt as Check, E as Share2, R as Plus, Rt as ChevronLeft, S as ShoppingCart, W as Minus, j as RotateCcw, n as X, q as Menu, u as Truck, v as Star, w as ShieldCheck } from "../_libs/lucide-react.mjs";
...
import { a as SmartImage, o as logotipo_default, r as SearchIcon, t as Layout } from "./Layout-DHYunb_r.mjs";
import { t as ProductCard } from "./ProductCard-C5LYJbkP.mjs";
import { n as nativeShare, t as ShareSheet } from "./ShareSheet-CZf1Vi6y.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product._id-JxAEYFa3.js
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: `h-4 w-4 ${i < Math.round(avgRating) ? "fill-gold text-gold" : "text-muted-foreground/40"}` }, i)), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
