...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/orders-store-fkxM3akK.js
var STAGE_FLOW = [
	"awaiting_payment",
	"payment_review",
	"payment_rejected",
...
function notifyCustomer(order, pkg, note) {
	...
	if (order.uid) import("./notifications-DWcdbMoD.mjs").then(({ pushNotificationTo }) => pushNotificationTo(order.uid, {
		kind,
		title,
		body,
		href: "/orders"
