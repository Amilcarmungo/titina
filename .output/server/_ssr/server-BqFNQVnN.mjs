...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BHn1l3qY.mjs");
...
var manifest = { "2fa18c9031533ccf5681f8a82f713b2cf97179e9fcc1cbf44fa8f415e55ab137": {
	...
	importer: () => import("./support-chat.functions-BDUPdDtf.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CVF9r1DU.mjs").then((n) => n.l).then((n) => n.t),
