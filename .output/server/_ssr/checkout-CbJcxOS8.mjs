...
import { c as actions, u as useStore } from "./router-Dtl-Myoz.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/checkout-CbJcxOS8.js
...
function CheckoutPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		listAddresses(uid).then((rows) => {
			...
			if (def.name && def.street && def.city) setStep((s) => s === 1 ? 2 : s);
