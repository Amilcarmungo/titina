...
import { F as useStore } from "./router-BKH7YloI.mjs";
import { n as require_react } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
import { l as useOrders } from "./orders-store-CICR66I0.mjs";
...
import { a as SmartImage, i as Skeleton, t as Layout } from "./Layout-DPypAtH7.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DTVGX89A.js
...
function Home() {
	...
	const feedProducts = (0, import_react.useMemo)(() => {
		const category = tab === 0 ? null : active.slugs.length === 1 ? active.slugs[0] : null;
		const source = category ? products.filter((product) => product.category === category) : products;
