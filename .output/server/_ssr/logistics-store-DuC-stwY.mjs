...
//#region node_modules/.nitro/vite/services/ssr/assets/logistics-store-DuC-stwY.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var PLATFORM_FEE = .05;
var KEY = "shop_logistics_v1";
var SETTINGS_KEY = "shop_shipping_settings_v1";
var defaultSettings = {
	freeShippingEnabled: true,
	freeShippingThreshold: 12e4
};
var defaults = [
	{
...
var shippingActions = {
	update(patch) {
		settings = {
			...settings,
			...patch,
			freeShippingThreshold: Math.max(0, Number(patch.freeShippingThreshold ?? settings.freeShippingThreshold))
		};
...
function shippingOptions(subtotal, address) {
...
function quoteShipping(subtotal, carrierId, address) {
...
//#endregion
export { shippingActions as a, useCarriers as c, quoteShipping as i, useShippingSettings as l, PLATFORM_FEE as n, shippingOptions as o, carrierActions as r, splitFreight as s, CARRIER_LABEL as t };
