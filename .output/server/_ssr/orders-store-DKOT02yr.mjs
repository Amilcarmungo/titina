...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/orders-store-DKOT02yr.js
var STAGE_FLOW = [
	"awaiting_payment",
	"payment_review",
	"payment_accepted",
...
function notifyCustomer(order, pkg, note) {
	...
	if (order.uid) import("./notifications-B9be_DLk.mjs").then(({ pushNotificationTo }) => pushNotificationTo(order.uid, {
		kind,
		title,
		body,
		href: "/orders"
