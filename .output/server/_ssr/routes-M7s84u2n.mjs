...
import { i as useAllProducts, o as useProductsStatus, r as retryProducts } from "./products-store-Hd0VqZmZ.mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { It as ChevronRight, Lt as ChevronLeft, t as Zap } from "../_libs/lucide-react.mjs";
import { i as useHomeConfig, n as setActiveHomeTab, r as useActiveHomeTab } from "./home-config-eImTCgTh.mjs";
import { n as useCategories, r as useCategoriesStatus } from "./categories-store-DOmO1cei.mjs";
import { a as useBannersStatus, n as setBannerIndex, o as useSlides, t as retryBanners } from "./banner-hgbhcP1m.mjs";
import { t as formatKz } from "./format-DAL2ZktZ.mjs";
import { a as SmartImage, i as Skeleton, t as Layout } from "./Layout-28T_vqtX.mjs";
import { t as ProductCard } from "./ProductCard-CbaR7tDb.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-M7s84u2n.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "mb-3 font-display text-xl md:text-2xl font-bold",
					children: !active.slugs.length ? "Recomendados para você" : `${active.label} — seleção`
				}), prodStatus === "loading" && !filtered.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4",
					children: Array.from({ length: 10 }).map((_, k) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					className: "columns-2 md:columns-4 lg:columns-5 gap-3 md:gap-4 [column-fill:_balance]",
					children: filtered.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
