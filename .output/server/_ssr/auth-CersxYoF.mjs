...
import { l as setDoc, m as doc, n as getDoc, u as updateDoc, v as serverTimestamp } from "../_libs/@firebase/firestore+[...].mjs";
import { n as getDb, t as firebaseEnabled } from "./client-nkMekIqc.mjs";
import { n as require_react } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
import { D as signUpWithEmail, F as captureReferralFromUrl, N as useStore, T as signInWithGoogle, _ as linkGoogleToPasswordAccount, b as resetPassword, f as authErrorMessage, m as emailHasAccount, n as NeedsPasswordLinkError, w as signInWithEmail } from "./router-DRadbe1d.mjs";
import { S as useRouter, v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { Ct as Eye, Lt as ChevronLeft, Rt as ChevronDown, U as PackageOpen, m as Ticket, u as Truck, wt as EyeOff } from "../_libs/lucide-react.mjs";
import { t as sendAppEmail } from "./send-6FcbH887.mjs";
import { o as bazarixy_mark_webp_asset_default, t as Layout } from "./Layout-28T_vqtX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-CersxYoF.js
...
async function sendVerificationCode(uid, email, name) {
	...
	await setDoc(doc(db, "users", uid, "security", "emailVerification"), {
	...
	return sendAppEmail("verify-email", email, {
		code,
		name,
		minutes: MINUTES
	});
...
async function confirmVerificationCode(uid, code) {
	const db = getDb();
	if (!db) return {
		ok: false,
	...
	if (!snap.exists()) return {
		ok: false,
		error: "Peça um novo código."
	};
	const data = snap.data();
	if ((data.attempts ?? 0) >= 6) return {
		ok: false,
...
function AuthPage() {
	...
	*/
	...
	const doSignUp = () => guard(async () => {
		...
		sendVerificationCode(created.uid, created.email, created.name);
	});
