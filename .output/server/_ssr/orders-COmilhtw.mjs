...
import { a as orderActions, l as useOrders, n as STAGE_FLOW, o as packagesOf, r as STAGE_LABEL, t as STAGE_DESC } from "./orders-store-D4TWKxP-.mjs";
import { t as getAnyProduct } from "./products-store-Hd0VqZmZ.mjs";
import { N as useStore, d as addPoints, l as actions } from "./router-DRadbe1d.mjs";
import { b as useSearch, v as Link, y as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { G as MessageSquare, H as Package, It as ChevronRight, J as MapPin, Lt as ChevronLeft, Nt as CircleCheck, Ot as CreditCard, Zt as ArrowDown, c as Undo2, d as TriangleAlert, j as RotateCcw, jt as Clock, n as X, u as Truck, v as Star } from "../_libs/lucide-react.mjs";
import { t as formatKz } from "./format-DAL2ZktZ.mjs";
import { n as markOrderReviewed, r as reviewActions, t as isOrderReviewed } from "./reviews-tc0COl-G.mjs";
import { a as SmartImage, t as Layout } from "./Layout-28T_vqtX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/orders-COmilhtw.js
...
function ReviewModal({ order, onClose }) {
	...
	const submit = () => {
		...
		if (text.trim().length < 5) {
			toast.error("Escreva um comentário maior");
			return;
		}
		reviewActions.add({
		...
		addPoints(50);
		toast.success(`Avaliação publicada! +50 pontos`);
		onClose();
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						onClick: submit,
						className: "flex-1 rounded-full bg-brand-strong py-3 text-sm font-black text-white hover:opacity-90",
						children: "Publicar avaliação"
					})]
				})
			]
		})
