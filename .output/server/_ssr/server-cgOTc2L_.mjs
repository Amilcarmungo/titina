...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-cUt5fWto.mjs");
...
var manifest = { "2fa18c9031533ccf5681f8a82f713b2cf97179e9fcc1cbf44fa8f415e55ab137": {
	functionName: "askSupport_createServerFn_handler",
	importer: () => import("./support-chat.functions-Dm4D0nwZ.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CVfpnsdH.mjs").then((n) => n.S).then((n) => n.t),
