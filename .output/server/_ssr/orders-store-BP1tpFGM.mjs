...
import { t as getAnyProduct } from "./products-store-De4HElAo.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/orders-store-BP1tpFGM.js
var STAGE_FLOW = [
	"awaiting_payment",
	"payment_review",
	"payment_rejected",
...
function notifyCustomer(order, pkg, note) {
	...
	if (order.uid) import("./notifications-CIUnz1pX.mjs").then(({ pushNotificationTo }) => pushNotificationTo(order.uid, {
		kind,
		title,
		body,
		href: "/orders"
