...
import { Ct as Flame, D as Share2, Vt as ChevronLeft, Xt as BadgeCheck, v as Store, y as Star } from "../_libs/lucide-react.mjs";
import { n as SmartImage } from "./SmartImage-BH5TwHiu.mjs";
import { r as useShops, t as getShop } from "./shops-store-Dm5LimXI.mjs";
import { d as shareText, f as shopUrl } from "./site-BzUm8isV.mjs";
import { H as notFound, v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { i as Route$2, u as useStore } from "./router-C1fI1gmX.mjs";
import { i as requireAuth, t as Layout } from "./Layout-BFx64orT.mjs";
import { t as ProductCard } from "./ProductCard-BvNzoNFn.mjs";
import { toggleFollow, useFollowedShops } from "./follows-Btp9dQJp.mjs";
import { n as nativeShare, t as ShareSheet } from "./ShareSheet-nj4l_klo.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shop._id-CJvLgLx0.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ShopPage() {
	const { id, shop: loadedShop } = Route$2.useLoaderData();
	useShops();
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShareSheet, {
				...
				target: {
					url: shopUrl(id),
					title: shop.name,
					text: shareText(shop.name, shop.description, "Descubra esta loja na Bazarixy"),
