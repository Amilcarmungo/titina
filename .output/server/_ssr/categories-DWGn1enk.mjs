...
import { Mt as Clock, k as Search, l as Trophy, n as X, x as SlidersHorizontal, xt as Flame, zt as ChevronLeft } from "../_libs/lucide-react.mjs";
import { n as SmartImage } from "./SmartImage-BH5TwHiu.mjs";
import { S as useRouter, v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { u as useStore } from "./router-T2sJYex6.mjs";
import { t as Layout } from "./Layout-Ca6gJpWe.mjs";
import { i as recordSearchIntent } from "./recommendations-DtzW4eO9.mjs";
import { trackSearch } from "./user-data-DXEcUX7Y.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/categories-DWGn1enk.js
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: results.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/product/$id",
							params: { id: p.id },
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-start gap-3 p-2 md:block md:p-0",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "relative h-24 w-24 shrink-0 overflow-hidden bg-muted md:h-40 md:w-full",
									...
									className: "min-w-0 flex-1 p-2 md:p-2.5",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "line-clamp-2 text-xs leading-tight md:text-sm",
											children: p.name
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-1 hidden text-[11px] leading-snug text-muted-foreground md:line-clamp-2",
											children: p.description ?? "Produto em destaque com qualidade e entrega rápida."
										})
									]
								})]
							})
