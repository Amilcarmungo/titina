...
import { C as ShoppingBag, G as MessageSquare, H as Package, Xt as ArrowLeft, _ as Store, v as Star } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.lojas._id-D5Tx2mIP.js
			...
			tab === "products" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [shopProducts.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-sm text-muted-foreground",
						children: ["Nenhum produto nesta loja. ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/admin/produtos",
