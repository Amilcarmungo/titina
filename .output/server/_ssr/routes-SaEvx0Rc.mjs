...
import { F as useStore } from "./router-DQBwzykF.mjs";
import { n as require_react } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
import { l as useOrders } from "./orders-store-BP1tpFGM.mjs";
import { i as useAllProducts, o as useProductsStatus, r as retryProducts } from "./products-store-De4HElAo.mjs";
...
import { a as useBannersStatus, n as setBannerIndex, o as useSlides, t as retryBanners } from "./banner-ExvINgH1.mjs";
...
import { a as SmartImage, i as Skeleton, t as Layout } from "./Layout-ByFmfVKk.mjs";
import { a as useRecommendationSignals, t as rankFeedProducts } from "./recommendations-CqZxQjbZ.mjs";
import { t as ProductCard } from "./ProductCard-umBIc6tM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-SaEvx0Rc.js
...
function Home() {
	...
	const [visibleCount, setVisibleCount] = (0, import_react.useState)(FEED_PAGE_SIZE);
	const feedEndRef = (0, import_react.useRef)(null);
	const feedProducts = rankFeedProducts(products, {
		favorites,
		orders,
		category: tab === 0 ? null : active.slugs.length === 1 ? active.slugs[0] : null,
		seed: feedSeed
	});
