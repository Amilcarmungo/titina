...
import { c as WHATSAPP, r as PHONE, t as INSTAGRAM } from "./router-DRadbe1d.mjs";
...
import { Ft as ChevronUp, It as ChevronRight, K as MessageCircle, O as Send, Ot as CreditCard, Rt as ChevronDown, U as PackageOpen, at as Instagram, j as RotateCcw, t as Zap, u as Truck, z as Phone } from "../_libs/lucide-react.mjs";
import { o as bazarixy_mark_webp_asset_default, t as Layout } from "./Layout-28T_vqtX.mjs";
import { i as getServerFnById, n as createServerFn, r as TSS_SERVER_FUNCTION } from "./server-BZSXEwNl.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/support-D7TOtdvY.js
...
var askSupport = createServerFn({ method: "POST" }).inputValidator((data) => schema.parse(data)).handler(createSsrRpc("2fa18c9031533ccf5681f8a82f713b2cf97179e9fcc1cbf44fa8f415e55ab137"));
var SHORTCUTS = [
	{
		icon: Zap,
...
function SupportPage() {
	...
	const send = async (text) => {
		...
		try {
			...
			setMessages([...next, {
				role: "assistant",
				content: "Falhou a ligação. Tente de novo ou fale no WhatsApp +244 934 033 532."
			}]);
		} finally {
			setLoading(false);
		}
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: ["Mais ", faqOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronUp, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "h-3.5 w-3.5" })]
								})]
