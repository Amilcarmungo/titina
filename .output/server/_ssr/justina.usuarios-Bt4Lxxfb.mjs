...
import { K as onSnapshot, L as getDocs, Lt as collection, et as query, ut as where } from "../_libs/@firebase/firestore+[...].mjs";
import "../_libs/firebase.mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { A as Search, T as ShieldCheck, Y as MapPin, a as UsersRound, et as Loader, i as Users, n as X } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/justina.usuarios-Bt4Lxxfb.js
		...
		children: [
			...
			state === "ready" && (list.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "hidden grid-cols-[1fr_auto_auto_auto] gap-4 border-b border-border px-4 py-3 text-[11px] font-black uppercase tracking-wider text-muted-foreground lg:grid",
					children: [
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "grid h-10 w-10 shrink-0 place-items-center overflow-hidden rounded-full bg-muted text-sm font-black",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "inline-flex w-fit items-center gap-1 rounded-full bg-gold/15 px-2.5 py-1 text-xs font-bold text-gold lg:justify-center",
								children: [
...
function UserModal({ user, onClose, loading }) {
