...
import { Jt as ArrowRight, Q as LockKeyhole, Y as Mail, w as ShieldCheck } from "../_libs/lucide-react.mjs";
import { t as Layout } from "./Layout-28T_vqtX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/privacidade-CWBf5q3u.js
...
var sections = [
	...
	},
	{
		...
		paragraphs: ["O responsável pelo tratamento dos dados pessoais recolhidos através da plataforma Bazarixy é o próprio Bazarixy, enquanto entidade responsável pela operação e gestão dos seus serviços digitais.", "Para questões relacionadas com privacidade e proteção de dados, pode contactar-nos através do email suporte@bazarixy.com."]
	},
	{
		id: "3",
	...
	},
	{
		...
		paragraphs: ["O Bazarixy aplica medidas técnicas e organizacionais destinadas a proteger os dados dos utilizadores contra acesso não autorizado, perda, alteração indevida, divulgação não autorizada e utilização abusiva.", "Apesar dos esforços de segurança, nenhum sistema digital pode garantir proteção absoluta contra todos os riscos existentes na internet."]
	},
	{
		id: "7",
		title: "7. PAGAMENTOS E COMPROVATIVOS",
		paragraphs: ["Quando o utilizador realiza pagamentos através de métodos como Multicaixa Express, Unitel Money, PayPay ou outros meios disponíveis, os dados necessários para validação da transação poderão ser tratados pelo Bazarixy.", "Comprovativos de pagamento enviados pelo utilizador serão utilizados exclusivamente para confirmação da compra e prevenção de fraudes."]
	},
	{
		id: "8",
		title: "8. COOKIES E TECNOLOGIAS SEMELHANTES",
		paragraphs: ["O Bazarixy poderá utilizar cookies e tecnologias semelhantes para melhorar o funcionamento da plataforma, guardar preferências do utilizador, analisar a utilização dos serviços e melhorar a experiência de navegação.", "O utilizador poderá controlar ou limitar cookies através das configurações do seu navegador."]
	},
	{
		id: "9",
		title: "9. ARMAZENAMENTO DOS DADOS",
		paragraphs: ["Os dados pessoais serão armazenados pelo período necessário para cumprir as finalidades para as quais foram recolhidos, incluindo obrigações legais, resolução de conflitos e segurança da plataforma.", "Após esse período, os dados poderão ser eliminados ou anonimizados."]
	},
	{
		id: "10",
	...
	},
	{
		...
		paragraphs: ["A plataforma Bazarixy não é destinada a utilizadores que não possuam capacidade legal para realizar compras sem autorização dos seus responsáveis.", "Caso sejam identificados dados recolhidos indevidamente de menores, o Bazarixy poderá tomar medidas para eliminar essas informações."]
	},
	{
		id: "12",
		title: "12. ALTERAÇÕES A ESTA POLÍTICA",
		paragraphs: ["O Bazarixy poderá atualizar esta Política de Privacidade sempre que necessário para refletir mudanças nos serviços, tecnologias utilizadas ou requisitos legais.", "A versão atualizada estará sempre disponível na plataforma."]
	},
	{
		id: "13",
		title: "13. CONTACTO",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: "Política de Trocas e Devoluções"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/support",
