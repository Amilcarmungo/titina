...
//#region node_modules/.nitro/vite/services/ssr/assets/recommendations-KUKDzl1l.js
...
function rankFeedProducts(products, options = {}) {
	const categories = Array.isArray(options.category) ? options.category : options.category ? [options.category] : [];
	const source = categories.length ? products.filter((product) => categories.includes(product.category)) : products;
	const signals = readSignals();
