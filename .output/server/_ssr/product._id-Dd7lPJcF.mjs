...
import { t as getAnyProduct } from "./products-store-Hd0VqZmZ.mjs";
import { r as useShops } from "./shops-store-BUK4rBQe.mjs";
import { L as productUrl, N as useStore, l as actions, o as Route$3 } from "./router-DRadbe1d.mjs";
...
import { E as Share2, Lt as ChevronLeft, R as Plus, S as ShoppingCart, W as Minus, j as RotateCcw, n as X, q as Menu, u as Truck, v as Star, w as ShieldCheck, zt as Check } from "../_libs/lucide-react.mjs";
import { t as formatKz } from "./format-DAL2ZktZ.mjs";
import { i as useReviews } from "./reviews-tc0COl-G.mjs";
import { n as colorName } from "./colors-IpFQMiOM.mjs";
import { a as SmartImage, r as SearchIcon, s as logotipo_default, t as Layout } from "./Layout-28T_vqtX.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/product._id-Dd7lPJcF.js
					...
					children: [
						variants.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: ["Opção: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						variants.length === 0 && product.colors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-xs text-muted-foreground",
							children: ["Cor: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-bold text-foreground",
						...
						sizeList.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-xs text-muted-foreground",
								children: ["Tamanho: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-bold text-foreground",
									children: size
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [product.sold.toLocaleString("pt-BR"), " vendidos"] })]
									})] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: product.rating.toFixed(2)
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex flex-col gap-0.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-0.5",
										children: [Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: `h-4 w-4 ${i < Math.round(product.rating) ? "fill-gold text-gold" : "text-muted-foreground/40"}` }, i)), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [userReviews.map((rv) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "py-3",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-between",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center gap-2",
												children: [
													rv.photoURL ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
														src: rv.photoURL,
														alt: rv.name,
														referrerPolicy: "no-referrer",
														className: "h-7 w-7 shrink-0 rounded-full object-cover"
													}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: "grid h-7 w-7 place-items-center rounded-full bg-gold/20 text-[11px] font-bold text-gold",
														children: rv.name[0]?.toUpperCase()
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: "flex items-center gap-0.5",
														children: Array.from({ length: 5 }).map((_, j) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: `h-3 w-3 ${j < rv.rating ? "fill-gold text-gold" : "text-muted-foreground/30"}` }, j))
													})
												]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-[10px] text-muted-foreground",
												children: rv.size ? `Tam: ${rv.size}` : rv.createdAt
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											children: "👍 Útil · Compra verificada"
										})
									]
								}, rv.id)), [
									{
										...
										text: "Produto incrível! Tecido de ótima qualidade e veste perfeitamente. Recomendo!"
									},
									{
										name: "Carla F.",
										rating: 5,
										size: "P",
										color: product.colors[0],
										text: "Material macio e nenhum defeito de costura. Adorei, vou comprar em outra cor."
									},
									{
										name: "Joana R.",
										rating: 4,
										...
										text: "Adorei o design e a textura. Apenas a parte do pescoço ficou um pouco apertada."
									}
								].map((rv, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "py-3",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-between",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: "grid h-7 w-7 place-items-center rounded-full bg-muted text-[11px] font-bold",
														children: rv.name[0]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "text-xs font-semibold",
