...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B6ZB0uwT.mjs");
...
var manifest = { "2fa18c9031533ccf5681f8a82f713b2cf97179e9fcc1cbf44fa8f415e55ab137": {
	...
	importer: () => import("./support-chat.functions-BM_5G3ON.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BdTihO2k.mjs").then((n) => n.x).then((n) => n.t),
