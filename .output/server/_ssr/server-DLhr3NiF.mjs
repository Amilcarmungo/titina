...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-I6kLzKIQ.mjs");
...
var manifest = { "2fa18c9031533ccf5681f8a82f713b2cf97179e9fcc1cbf44fa8f415e55ab137": {
	...
	importer: () => import("./support-chat.functions-BUPCO9k6.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C57BLtN5.mjs").then((n) => n.S).then((n) => n.t),
