...
import { Rt as ChevronDown } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/coupons-Cx0x790B.js
				...
				children: [
					...
					open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["· ", c.type === "percent" ? `Desconto de ${c.value}% sobre o subtotal.` : `Desconto de ${formatKz(c.value)} sobre o subtotal.`] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["· ", c.minOrder > 0 ? `Válido em pedidos a partir de ${formatKz(c.minOrder)}.` : "Sem valor mínimo de pedido."] }),
